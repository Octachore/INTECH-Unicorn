...
namespace ITI.Unicorn.Tests.Level1
{
    public class S01_Unicorn
    {
        ...
        public void P01_Unicorn_Uni(int[] input, string[] expected)
        {
            string[] result = P01_Unicorn.GetSolution(input);
        ...
        public void P01_Unicorn_Corn(int[] input, string[] expected)
        {
            string[] result = P01_Unicorn.GetSolution(input);
        ...
        public void P01_Unicorn_flakes(int[] input, string[] expected)
        {
            string[] result = P01_Unicorn.GetSolution(input);
        ...
        public void P01_Unicorn_UniCornFlakes(int[] input, string[] expected)
        {
            string[] result = P01_Unicorn.GetSolution(input);
